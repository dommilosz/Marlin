...
#define CUSTOM_MACHINE_NAME "Ender-3 Pro SKR2"
...
#define PIDTEMPBED
  ...
  #define DEFAULT_bedKp 117.87
  #define DEFAULT_bedKi 21.05
  #define DEFAULT_bedKd 440.03
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -45, -37, 0 }
